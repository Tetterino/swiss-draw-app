          ...
          <TableRow>
            ...
            {showTiebreakers && (
              <>
                ...
                <Tooltip title="対戦相手のマッチポイントの合計" arrow>
                  <TableCell align="center" sx={{ fontWeight: 700, cursor: 'help' }}>対手累点</TableCell>
                </Tooltip>
              </>
            )}
          </TableRow>
            ...
            >
              ...
              {showTiebreakers && (
                <>
                  ...
                  <TableCell align="center">
                    <Typography variant="body2">{s.opponentTotalPoint}</Typography>
                  </TableCell>
                </>
              )}
            </TableRow>
